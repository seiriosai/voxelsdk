...
#ifndef VOXEL_TOFPCLVIEWER_H
#define VOXEL_TOFPCLVIEWER_H
...
protected:
  ...
  void _cloudRenderCallbackPCF(const Voxel::PointCloudFrame &cloud);
  void _cloudRenderCallbackDepthF(const Voxel::DepthFrame &df);
  void _cloudRenderCallbackRawF(const Voxel::RawFrame &f, const Voxel::DepthCamera::FrameType type);
